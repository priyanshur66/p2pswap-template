...
contract AtomicSwapERC20 {
     ...
     */
    event LockBuy(ERC20 indexed token, address indexed creator, address indexed recipient, bytes32 hashedSecret, uint timeout, uint value, bytes32 sellAssetId, uint sellPrice,bytes32 lockId);
        ...
        
    {
        ...
        emit LockBuy(token, msg.sender, recipient, hashedSecret, timeout, value, sellAssetId, sellPrice,lockId);
